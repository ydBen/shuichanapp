...
public class AutoWifiDiscoveringActivity extends Activity implements OnClickListener {
        ...
        switch (Status) {
            ...
            case STATUS_ADDING_CAMERA:
                ...
                if(mEZProbeDeviceInfo == null) {
                    ...
                    mEZProbeDeviceInfo.setStatus(1);//设备已在线
    ...
    private void addCameraFailed(int errorStep, int errorCode) {
        ...
        switch (errorStep) {
            ...
            case ERROR_ADD_CAMERA:
                ...
                || errorCode == ErrorCode.ERROR_WEB_DEVICE_ADDED
                || errorCode == ErrorCode.ERROR_WEB_DEVICE_ONLINE_ADDED
                || errorCode == ErrorCode.ERROR_WEB_DEVICE_OFFLINE_ADDED) {
     ...
     * 获取设备信息任务
     */
    private class GetCamersInfoTask extends AsyncTask<Void, Void, EZProbeDeviceInfo> {
        ...
        @Override
        protected EZProbeDeviceInfo doInBackground(Void... params) {
            ...
            try {
                return EzvizApplication.getOpenSDK().probeDeviceInfo(serialNo);
        ...
        protected void onPostExecute(EZProbeDeviceInfo result) {
            ...
            if (result != null) {
                mEZProbeDeviceInfo = result;
                if(mEZProbeDeviceInfo.getStatus() == 1) {//设备在线，已被自己添加
                    changeStatuss(STATUS_ADD_CAMERA_SUCCESS);
