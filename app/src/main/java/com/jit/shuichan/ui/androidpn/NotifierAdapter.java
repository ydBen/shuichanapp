...
import com.jit.shuichan.ui.message.AlarmType;
        ...
        if (alarmLogInfo != null) {
            ...
            if (alarmLogInfo.getNotifyType() == AlarmLogInfoEx.ALARMTYPE) {
                ...
                if (alarmType.hasCamera()) {
                    EZUtils.loadImage(mContext,viewHolder.iconIv,alarmLogInfo.getAlarmPicUrl(),alarmLogInfo.getDeviceSerial(),null);
                } else {
