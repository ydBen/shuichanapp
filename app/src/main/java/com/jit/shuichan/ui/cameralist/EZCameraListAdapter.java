...
public class EZCameraListAdapter extends BaseAdapter {
    ...
    public static class ViewHolder {
        ...
        public TextView cameraStatusTv;
    ...
    public EZCameraListAdapter(Context context) {
        ...
        Log.e("adapter","来到了adapter的构造方法，获取到到摄像头数量是:" + mCameraInfoList.size());
    ...
    @Override
    public int getCount() {
        if (mUser.equals("admin")){//管理员权限
            Log.e("adapter","admin");
            if (mCameraInfoList.size()!=0){
                return mCameraInfoList.size();
            }
        }else if (mUser.equals("渔网1")){//渔网1权限
            Log.e("adapter","渔网1");
            if (mCameraInfoList.size()!=0){
                return 1;
            }

        }else if (mUser.equals("渔网2")){//渔网2权限
            Log.e("adapter","渔网2");
            if (mCameraInfoList.size()!=0){
                return 1;
            }

        }else if (mUser.equals("渔网3")){//渔网3权限
            Log.e("adapter","渔网3");
            if (mCameraInfoList.size()!=0){
                return 1;
            }
        }
        Log.e("adapter","来到了getCount方法，获取到到摄像头数量是:" + mCameraInfoList.size());
        return 0;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.cameraStatusTv = (TextView) convertView.findViewById(R.id.camera_status_tv);
            viewHolder.statusRl = (RelativeLayout) convertView.findViewById(R.id.rl_statusbg);
        ...
        viewHolder.statusRl.getBackground().setAlpha(50);
        ...
        if (mUser.equals("admin")){
            ...
            if (deviceInfo != null){
                if (deviceInfo.getStatus() == 2) {//设备不在线
                    ...
                    viewHolder.cameraStatusTv.setText("设备状态:不在线");
                    viewHolder.iconIv.setImageResource(R.mipmap.offlinebg);
                } else {//设备在线
                    ...
                    viewHolder.cameraStatusTv.setText("设备状态:在线");
                    viewHolder.iconIv.setImageResource(R.mipmap.offlinebg);
                }
...
//            }
            ...
            for (int i = 0; i < mCameraInfoList.size(); i++) {
                final EZDeviceInfo deviceInfo = mCameraInfoList.get(i);
                final EZCameraInfo cameraInfo = EZUtils.getCameraInfoFromDevice(deviceInfo, 0);
                if (mUser.equals("渔网1")) {

                    mTag = i;

                    if (deviceInfo.getDeviceSerial().equals("705542577")) {
                    ...
                    if (deviceInfo.getDeviceSerial().equals("705542620")) {
                    ...
                    if (deviceInfo.getDeviceSerial().equals("705542628")) {
