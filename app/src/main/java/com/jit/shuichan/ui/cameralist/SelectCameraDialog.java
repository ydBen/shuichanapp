...
import com.jit.shuichan.http.BitmapHelper;
    ...
    class MyAdatpter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView == null) {
                ...
                holder.mCoverIV = (ImageView) convertView.findViewById(R.id.iv_mycover);
                holder.mCameraNameTV = (TextView) convertView.findViewById(R.id.tv_devicename);
...
//                mNetCacheUtils.getBitmapFromNet(holder.mCoverIV,"http://img.ys7.com/group2/M00/6C/A3/CmGCBVh0P--AFxYcAABGcCELLeA770.jpg");
                mBitmapUtils.display(holder.mCoverIV,ezCameraInfo.getCameraCover());
                holder.mCameraNameTV.setText(TextUtils.isEmpty(ezCameraInfo.getCameraName())?"未命名":String.valueOf(ezCameraInfo.getCameraNo()) + "." + ezCameraInfo.getCameraName());
                Log.e("Camera","缩略图、设备号、设备名称、设备状态" + ezCameraInfo.getDeviceSerial() + ezCameraInfo.getCameraCover() + String.valueOf(ezCameraInfo.getCameraNo()) + String.valueOf(mEZDeviceInfo.getStatus()));
            }
            return convertView;
        }
    }
