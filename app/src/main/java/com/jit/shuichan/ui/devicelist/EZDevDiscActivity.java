 ...
 * @warning 这里写本文件的相关警告
 */
package com.jit.shuichan.ui.devicelist;
...
public class EZDevDiscActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        findViews();
        EzvizApplication.getOpenSDK().startConfigWifi(this, wifiSSID, wifiPassword, deviceDiscoveryListener);
    }
            ...
            if (msg.what == 0) {
                ...
                if (DevceState.WIFI == deviceInfo.getState() || DevceState.REPORT == deviceInfo.getState()) {                    
                    ...
                    if(deviceDiscoverInfo == null) {
                        ...
                        deviceDiscoverInfo.deviceSerial = deviceInfo.getSerialNo();
                        deviceDiscoverInfo.deviceName = deviceInfo.getType()+"("+deviceDiscoverInfo.deviceSerial+")";
                        discoverMap.put(deviceDiscoverInfo.deviceSerial, deviceDiscoverInfo);
     ...
     * 获取设备信息任务
     */
    private class GetCamersInfoTask extends AsyncTask<DeviceDiscoverInfo, Void, EZProbeDeviceInfo> {
        ...
        @Override
        protected EZProbeDeviceInfo doInBackground(DeviceDiscoverInfo... params) {
            ...
            try {
                return EzvizApplication.getOpenSDK().probeDeviceInfo(deviceDiscoverInfo.deviceSerial);
        ...
        @Override
        protected void onPostExecute(EZProbeDeviceInfo result) {
            ...
            if (result != null) { 
                //设备已被自己添加
                deviceDiscoverInfo.mEZProbeDeviceInfo = result;
