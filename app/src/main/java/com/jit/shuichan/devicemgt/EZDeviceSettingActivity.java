package com.jit.shuichan.devicemgt;
...
public class EZDeviceSettingActivity extends RootActivity {
    ...
    private void initData() {
        mEZDeviceInfo = getIntent().getParcelableExtra(IntentConsts.EXTRA_DEVICE_INFO);
                ...
                public void onClick(View v) {
                    ...
                    switch (v.getId()) {
                        ...
                        case R.id.ez_device_serial_layout:
                            try {
                                if (EzvizApplication.getOpenSDK() != EZOpenSDK.getInstance()) {
